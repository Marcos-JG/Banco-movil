...
export const ENDPOINTS = {
  AUTH: resolveUrl(process.env.EXPO_PUBLIC_AUTH_URL, process.env.EXPO_PUBLIC_AUTH_BASE_URL, 'https://authservice-gestionbancaria-production.up.railway.app/api/v1'),
